...
public class DynamoDbAttributeConstants {
    ...
    public static final String LINK_ANALYTICS_ID = "link_id";
    public static final String LINK_ANALYTICS_DATE = "date";
    public static final String LINK_ANALYTICS_CLICKS = "clicks";
    public static final String LINK_ANALYTICS_UPDATED_AT = "updated_at";
